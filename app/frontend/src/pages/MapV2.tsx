...
import { fetchMapV2Filters, fetchMapV2Points, fetchMapV2Researchers, fetchMapV2Topics } from "../api";
...
const OMIT_TOPICS = new Set([23, 29]);
    ...
    <div className="page-container fade-in">
      <div className="atlas-shell">
        <header className="atlas-header">
          <div>
            <p className="atlas-eyebrow">TRISS Research Atlas - Map V2</p>
            <h1 className="page-title">Topic Cartography (MPNet)</h1>
